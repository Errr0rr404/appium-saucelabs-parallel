...
public class BaseConcurentTest implements SauceOnDemandSessionIdProvider{

    public static String username = "pntsauce";
    public static String accessKey = "194d0d1d-2b85-4eda-8249-9bcb3eecb16b";
    ...
    public static void setupClass() {
        ...
        app = "sauce-storage:samsclub.apk";
    }
}
